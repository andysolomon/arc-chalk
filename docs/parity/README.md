...
| Editor                         | 16,592 px Linux, unchanged by ADR 0046                                                                                              | 2026-09-13 (ADR 0046)                               |
...
| Demo                           | 1.60% (22,141 px) Linux, from 22,075 on `main`; under ratchet                                                                       | 2026-09-13 (ADR 0044)                               |
| Present                        | 104,148 px Linux, identical on `main` (no header in Present)                                                                        | 2026-09-13 (ADR 0044)                               |
| Print                          | 0.86% (11,937 px) Linux, from 11,553 on `main` — both above the macOS ratchet here by rasterization; passes with the CI delta       | 2026-09-13 (ADR 0044)                               |
| Shortcuts                      | 2.48% (34,301 px) Linux, from 33,817 on `main` — both above the macOS ratchet here; passes with the CI delta                        | 2026-09-13 (ADR 0044)                               |

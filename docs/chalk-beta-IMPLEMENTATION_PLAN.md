...
Closed 2026-08-21: inventory, remaining viewports/overlays/selection goldens, timing primitives, behavior scripts, and review-finding triage are in `docs/parity/` and the parity matrix. Generated export-file goldens stay with Phase 9.4.

...
- `docs/parity/` contains the first original-versus-production editor comparison plus a Bun-hosted Playwright harness that locks the original Editor, Demo, Present, and Print desktop modes at 1440 × 960. Panels, menus, modals, selection states, additional viewports, behaviors, and outputs remain incomplete.

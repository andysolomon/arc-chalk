...
2. Build Demo/Tour as the original's guided sequences, treating a demo handoff as a new unsaved Play (parity-matrix B1).
3. Close remaining 4.1 shell gaps: field viewBox aspect, tool-rail glyphs below the text tool, status-bar spacing, Formation-card row drift, and dynamic `paletteCommands`.
